...
#elif UNITY_EDITOR_WIN
				var newPath = Path.GetPathRoot(System.Environment.SystemDirectory) + Path.DirectorySeparatorChar + "PROGRA~2" + Path.DirectorySeparatorChar + "MIFA7F~1" + Path.DirectorySeparatorChar + "bin" + Path.DirectorySeparatorChar + "code.cmd";
#else
